describe('variable tests', () => {
  ...
  it('validates passing a var that holds a # as an arg to a func copies the value to the corresponding parameter args and reassigning the arg in the function will not alter the original var value', () => {
    let x = 10;
